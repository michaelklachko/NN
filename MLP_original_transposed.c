...
int dot1(float** array1, float** array2, float** result, int dim1, int dim2, int dim3, int transposed)
{
    ...
    float** A;
    float** B;
    float** array1_transposed;
    float** array2_transposed;
    ...
    {
	array1_transposed = alloc_2d_float(dim1, dim2);
	
	transpose(array1, array1_transposed, dim1, dim2);
    ...
    {
	array2_transposed = alloc_2d_float(dim2, dim3);
	
	transpose(array2, array2_transposed, dim2, dim3);
	    ...
	    float** batch_transposed)
{
    ...
    dot1(output_hidden, error_out, grad->W2, n_hidden, batch_size, n_out, 1);
    ...
    dot1(batch, error_hidden, grad->W1, img_size, batch_size, n_hidden, 1);
